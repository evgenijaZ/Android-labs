...
class ButtonsFragment : Fragment(), View.OnClickListener {
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.open_history_button -> listener?.onOpenHistoryButtonClick()
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        view.findViewById<Button>(R.id.open_history_button).setOnClickListener(this)
        return view
    }
